...
Собственно Chrome уже делает попытки предсказать ваше поведение на основании 
...
Amazon.com использует DNS-предвыборку для разрешения **нескольких доменных имен**, 
